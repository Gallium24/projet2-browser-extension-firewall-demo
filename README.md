...
7. Allez dans l'onglet **Réseau** (Network). Vous y verrez une requête sortante vers `httpbin.org` contenant la donnée volée dans l'URL. La vulnérabilité d'exfiltration est confirmée.
